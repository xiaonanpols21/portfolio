...
import SliderVerify from "@/components/portfolio/gallery/sliderVerify";
import Tags from "@/components/portfolio/tags/me";
import SocialMedia from "@/components/portfolio/links/socialMedia";
import Footer from "@/components/portfolio/footer";
import RadioVerify from "@/components/portfolio/gallery/radioVerify";
import styles from "./over.module.scss";

export default async function OverMij() {
    const fetchData = await fetch('https://xiaodesign.nl/wp-json/wp/v2/galleries?acf_format=standard')
